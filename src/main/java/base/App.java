...
r is the annual rate of interest, t is the number of years the amount is invested, and A
...
public class App {
    ...
    public static void main(String[] args) {
        ...
        String output = String.format("After %d years at %.1f%%, the investment will be worth $%.0f.\n", yearNum,interest, investment );
